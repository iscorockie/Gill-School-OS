  ...
  return {
    meta: {
      ...
      contacts: {
        ...
        email: "info.gillschool@gmail.com",
    ...
    users: [
      ...
      { id: "t-sharon", role: "teacher", name: "Ms. Sharon Namukasa", email: "s.namukasa@gill.sch", phone: "+256700111003", subject: "Pre-School Lead — Nursery" },
    ...
    invoices: [
      {
        ...
        status: "paid",
        lines: [
          { studentId: "s-pres-1", label: "Pre-School Tuition (Nursery)", kind: "tuition", amount: 450000, discount: 45000 },
      ...
      },
      {
        ...
        status: "unpaid",
        lines: [
          { studentId: "s-pres-2", label: "Pre-School Tuition (Toddlers)", kind: "tuition", amount: 450000, discount: 0 },
        ],
        siblingDiscount: 0,
        total: 450000,
        paid: 0,
      ...
      },
      {
        ...
        status: "unpaid",
        lines: [
          { studentId: "s-pres-3", label: "Pre-School Tuition (Nursery)", kind: "tuition", amount: 450000, discount: 0 },
      ...
      },
      {
        ...
        status: "unpaid",
        lines: [
          { studentId: "s-pres-4", label: "Pre-School Tuition — new intake (Nursery)", kind: "tuition", amount: 450000, discount: 0 },
    ...
    resources: [
      ...
      { id: "r-3", type: "Worksheet", title: "Phonics — sound blend set 12 (Nursery)", subject: "Literacy", stage: "Pre-School", campus: "preschool", addedBy: "t-sharon", date: "2026-08-18", downloads: 89, size: "420 KB", file: "/docs/phonics-set12.pdf" },
    ...
    assessments: [
      { id: "as-1", studentId: "s-main-1", subject: "English", term: "Term 2 2026", type: "Continuous assessment", title: "Reading comprehension — 'The River Child'", score: 78, max: 100, grade: "B+", teacher: "t-aisha", date: "2026-06-11", feedback: "Excellent inference skills. Focus on expanding vocabulary in descriptive writing.", remarkStudent: "Excellent inference skills — let's grow your descriptive vocabulary next.", remarkParent: "Jordan is reading with real confidence. At home, ask him to describe a scene in two sentences and underline the best words — that will stretch his writing." },
      { id: "as-2", studentId: "s-main-1", subject: "Mathematics", term: "Term 2 2026", type: "Continuous assessment", title: "Fractions & decimals quiz", score: 84, max: 100, grade: "A", teacher: "t-brian", date: "2026-06-18", feedback: "Strong grasp of equivalence. Watch the carrying step in decimal subtraction.", remarkStudent: "Great equivalence work! Re-check the carrying step when subtracting decimals.", remarkParent: "Fractions and decimals are solid. A short daily practice of two decimal subtraction sums will lock in the carrying step before the next topic." },
      { id: "as-3", studentId: "s-main-1", subject: "Science", term: "Term 2 2026", type: "Checkpoint (mock)", title: "Cambridge Primary Checkpoint practice — papers 1–2", score: 148, max: 180, grade: "A−", teacher: "t-brian", date: "2026-07-02", feedback: "Knowledge is secure. Practice graph interpretation and the written-answer paper style.", remarkStudent: "Your knowledge is secure — practise reading graphs and answering in full sentences.", remarkParent: "Jordan's Checkpoint practice is in good shape. Focus at home: one graph question and one written answer a week, timed." },
      { id: "as-4", studentId: "s-main-1", subject: "English", term: "Term 3 2026", type: "Continuous assessment", title: "Spelling & grammar starter", score: 9, max: 10, grade: "A", teacher: "t-aisha", date: "2026-08-28", feedback: "Great start to Term 3 — punctuation use is improving quickly.", remarkStudent: "Great start to Term 3 — your punctuation is improving quickly!", remarkParent: "A lovely start to Term 3. Reading aloud at home twice a week is helping; keep it up." },
      { id: "as-5", studentId: "s-main-1", subject: "Mathematics", term: "Term 3 2026", type: "Continuous assessment", title: "Place value & rounding warm-up", score: 16, max: 20, grade: "B+", teacher: "t-brian", date: "2026-08-29", feedback: "Solid recall; revise rounding to 2 decimal places.", remarkStudent: "Solid recall — just revise rounding to 2 decimal places.", remarkParent: "Recall is solid. Five minutes on rounding to 2 decimal places on Saturday will close the small gap." },
      { id: "as-6", studentId: "s-pres-1", subject: "Emergent Literacy", term: "Term 2 2026", type: "Observation", title: "Phonics — letter sounds s,a,t,p,i,n", score: 5, max: 6, grade: "Emerging+", teacher: "t-sharon", date: "2026-06-20", feedback: "Maya recognises all six sounds and blends 'sat' and 'pin' independently. Lovely progress!", remarkStudent: "Well done, Maya! You know s, a, t, p, i, n and can blend them.", remarkParent: "Maya recognises all six sounds and blends 'sat' and 'pin' by herself — lovely progress. Keep a picture book at bedtime." },
      { id: "as-7", studentId: "s-pres-1", subject: "Personal & Social", term: "Term 2 2026", type: "Observation", title: "Sharing & turn-taking", score: 4, max: 5, grade: "Secure", teacher: "t-sharon", date: "2026-07-01", feedback: "Maya is becoming a kind classroom helper. Encouraged to tidy up without prompting.", remarkStudent: "You're a kind classroom helper, Maya — keep tidying up!", remarkParent: "Maya is becoming a kind classroom helper in class. Praising her tidying at home will reinforce it." },
    ],
    ...
    // Family group chats — created automatically when a parent enables
    // "Receive messages from teachers" for a child (perms.messages).
    // Parents view every message (monitor mode) but can only reply about
    ...
    chats: [
      {
        ...
        studentId: "s-main-1",
        familyId: "fam-1",
        title: "Jordan Nansubuga — Year 5 · teacher & family group",
        status: "active",
        autoCreated: true,
        createdAt: "2026-08-29 09:10",
        members: [
          { userId: "t-aisha", role: "teacher", name: "Ms. Aisha Hassan" },
          { userId: "t-brian", role: "teacher", name: "Mr. Brian Mugisha" },
          { userId: "u-parent-1", role: "parent", name: "Amina Nansubuga" },
          { userId: "u-parent-1b", role: "parent", name: "Joseph Nansubuga" },
        ],
        messages: [
          {
            id: "cm-1", from: "t-aisha", role: "teacher", text: "Good morning! Term 3 reading logs start Monday — 20 minutes, four evenings a week. Jordan's Reading Zone books are in his bag.",
            tag: "general", date: "2026-08-29 09:12", readBy: ["t-aisha", "u-parent-1", "u-parent-1b"],
          },
          {
            id: "cm-2", from: "t-brian", role: "teacher", text: "Maths: we'll begin decimals with money this week. Any questions, post here — I reply same day.",
            tag: "general", date: "2026-08-29 10:04", readBy: ["t-brian", "u-parent-1"],
          },
        ],
      },
    ],
    ...
    familyAccounts: [
      {
        ...
        activatedAt: "2026-08-27 10:14",
        inviteLink: "https://portal.gillschool.ac.ug",
        inviteToken: "INV-NANS-4F2A", // legacy family — password already set & verified
        passwordSet: true,
        verified: true,
